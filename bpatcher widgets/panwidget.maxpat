...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 60.0, 75.0, 36.0, 20.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 150.0, 150.0, 33.0, 20.0 ],
									"text" : "float"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 215.0, 105.0, 36.0, 20.0 ],
									"text" : "[0, 1]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 180.0, 105.0, 32.5, 20.0 ],
									"text" : "/ 2."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 180.0, 75.0, 32.5, 20.0 ],
									"text" : "+ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 45.0, 210.0, 124.0, 20.0 ],
									"text" : "drunkplus 0.001 0.05"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 45.0, 300.0, 42.0, 20.0 ],
									"text" : "* 127."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 45.0, 180.0, 65.0, 20.0 ],
									"text" : "metro 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 240.0, 79.0, 20.0 ],
									"text" : "pack 0.1 500"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 173.0, 264.0, 54.5, 264.0 ],
									"source" : [ "obj-7", 1 ]
								}
...
,
					"patching_rect" : [ 255.0, 105.0, 54.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 195.0, 47.0, 21.0 ],
					"text" : "altreset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 30.0, 31.0, 21.0 ],
					"text" : "r init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 105.0, 33.5, 21.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 60.0, 32.5, 21.0 ],
					"text" : "64"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 30.0, 44.0, 21.0 ],
					"text" : "r #1init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 105.0, 45.0, 45.0, 21.0 ],
					"text" : "ctlin 28"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 90.0, 195.0, 43.0, 21.0 ],
					"text" : "/ 64."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 240.0, 79.0, 21.0 ],
					"text" : "stereopan"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 99.5, 229.0, 317.0, 229.0, 317.0, 99.0, 299.5, 99.0 ],
					"order" : 0,
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 99.5, 185.5, 174.5, 185.5 ],
					"order" : 0,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 174.5, 220.0, 242.0, 220.0, 242.0, 54.0, 204.5, 54.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 264.5, 144.0, 99.5, 144.0 ],
					"source" : [ "obj-7", 0 ]
				}
