...
,
		"rect" : [ 100.0, 148.0, 823.0, 688.0 ],
		"bglocked" : 0,
		"defrect" : [ 100.0, 148.0, 823.0, 688.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 660.0, 180.0, 41.0, 19.0 ],
					"text" : "tapin~"
				}
...
,
					"patching_rect" : [ 150.0, 630.0, 229.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 555.0, 32.5, 17.0 ],
					"text" : "70"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 585.0, 47.0, 19.0 ],
					"text" : "altreset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 585.0, 47.0, 19.0 ],
					"text" : "altreset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 675.0, 32.5, 17.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 645.0, 31.0, 19.0 ],
					"text" : "r init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 270.0, 780.0, 30.0, 19.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 60.0, 780.0, 30.0, 19.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 270.0, 735.0, 79.0, 19.0 ],
					"text" : "soundgate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 60.0, 735.0, 78.0, 19.0 ],
					"text" : "soundgate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 270.0, 705.0, 17.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 330.0, 660.0, 49.0, 19.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 120.0, 660.0, 49.0, 19.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 60.0, 705.0, 17.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 814.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 369.5, 607.0, 386.0, 607.0, 386.0, 578.0, 399.5, 578.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"hidden" : 0,
					"midpoints" : [ 564.5, 769.0, 290.5, 769.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 159.5, 609.0, 217.0, 609.0, 217.0, 582.0, 234.5, 582.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"hidden" : 0,
					"midpoints" : [ 489.5, 761.0, 80.5, 761.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 159.5, 546.0, 369.5, 546.0 ],
					"source" : [ "obj-53", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 39.5, 698.0, 279.5, 698.0 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 39.5, 698.0, 69.5, 698.0 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-52", 0 ],
					"hidden" : 0,
					"midpoints" : [ 234.5, 609.0, 274.0, 609.0, 274.0, 551.0, 159.5, 551.0 ],
					"source" : [ "obj-83", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-88", 0 ],
					"hidden" : 0,
					"midpoints" : [ 399.5, 607.0, 441.0, 607.0, 441.0, 544.0, 369.5, 544.0 ],
					"source" : [ "obj-87", 0 ]
				}
