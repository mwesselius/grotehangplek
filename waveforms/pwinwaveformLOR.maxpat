...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 435.0, 90.0, 32.5, 19.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 405.0, 120.0, 32.5, 19.0 ],
									"text" : "||"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 435.0, 60.0, 33.0, 19.0 ],
									"text" : "== 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 405.0, 210.0, 33.5, 19.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 390.0, 240.0, 33.5, 19.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 495.0, 180.0, 113.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 420.0, 180.0, 77.0, 19.0 ],
									"text" : "snapshot~ 10"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 495.0, 195.0, 104.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 420.0, 150.0, 149.0, 19.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"hidden" : 0,
									"midpoints" : [ 174.5, 54.0, 444.5, 54.0 ],
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 53.0, 165.0, 159.5, 165.0 ],
									"source" : [ "obj-56", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 53.0, 165.0, 399.5, 165.0 ],
									"source" : [ "obj-56", 1 ]
								}
